...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('danceevents');
'use strict';
...
angular.module('core').config(['$stateProvider', '$urlRouterProvider',
	function($stateProvider, $urlRouterProvider) {
		...
		state('event', {
			url: '/',
			templateUrl: 'modules/danceevents/views/list-danceevent.client.view.html'
		});
	}
]);
'use strict';
...
angular.module('users').config(['$stateProvider',
	function($stateProvider) {
		...
		//Use the users list template when all_users route is requested - Ray
		state('admin', {
			url: '/all_users',
			templateUrl: 'modules/users/views/users-list.client.view.html'
		});
...
angular.module('users').controller('SettingsController', ['$scope', '$http', '$location', 'Users', 'Authentication',
	function($scope, $http, $location, Users, Authentication) {
		...
		// Find a list of Users - Added by Ray 10/4/2015
		$scope.find = function() {
